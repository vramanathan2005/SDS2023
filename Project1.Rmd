...
```{r}
lepggplot + geom_point(aes(x = BagsProduced, y = Rating), col = 'blue', alpha = 0.5) + labs(title= "Distribution of Coffee Ratings by Bags Produced", x = 'Bags Produced', y= "Coffee Rating")
